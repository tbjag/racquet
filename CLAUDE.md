...
- **State**: Phases 1–6 complete and deployed. Phase 7 (frontend refactor) at commit 8/9 — sidebar, chat, call, and member list components extracted; toast + apiCall wired; theme infra; WebSocket reconnect with backoff and `ConnectionBanner`; visual styling pass complete. Remaining: polish (commit 9). 29 Rust tests + 46 Playwright tests passing.
